...
urlpatterns = [
    ...
    path(
        'events/registrations/export/all/',
        views.export_all_registrations_csv,
        name='export_all_registrations_csv',
    ),
    ...
    path(
        'events/<int:id>/registrations/export/',
        views.export_event_registrations_csv,
        name='export_event_registrations_csv',
    ),
